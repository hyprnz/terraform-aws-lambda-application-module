...
|------|-------------|------|---------|:--------:|
| alias_name | Name of the alias being created | `string` | n/a | yes |
...
| domain_name | The custom domain name for api gateway that points to lambda application | `string` | n/a | yes |
...
| custom_policy_description | Allows to override the custom Lambda policy's description | `string` | `"The custom policy for the Lambda application module execution role"` | no |
