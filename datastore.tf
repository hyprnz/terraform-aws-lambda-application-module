module "lambda_datastore" {
  source = "github.com/hyprnz/terraform-aws-data-storage-module?ref=v4.3.0"
  ...
  send_bucket_notifications_to_eventbridge = var.send_bucket_notifications_to_eventbridge
